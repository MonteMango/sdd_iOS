...
|---|---|---|---|---|---|---|
| T1 | Relocate + extend consultant-trigger.md / consultant-fold.md to `_shared/` | infra | Fork maintainer | M | — | todo |
| T2 | Write the 3 dedicated consultant agent files | domain | Fork maintainer | M | T1 | todo |
...
| T14 | Verify `implement` fixtures (AC-02, AC-05, AC-06) | tests | Fork maintainer | M | T4, T5, T6, T11 | todo |
| T15 | Verify `review` fixtures (AC-03, AC-05, AC-07, AC-09, AC-10b) | tests | Fork maintainer | M | T9, T11 | todo |
| T16 | Verify `sequences` fixtures (AC-08, AC-09, AC-10) | tests | Fork maintainer | S | T10, T11 | todo |
